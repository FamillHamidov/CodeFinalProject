...
namespace Travel.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Update(Models.Discount discount)
        {
            ...
            { Id = discount.Id, Rate = discount.Rate, UserId = discount.UserId, Code = discount.Code });
            //var status = await _dbConnection.ExecuteAsync($"Update discount set userid={discount.UserId}, code={discount.Code} " +
